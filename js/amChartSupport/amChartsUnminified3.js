    ...
    XFs4: function(e, t, i) {
                ...
                return r.c(t, e), t.prototype.validate = function() {
                    ...
                    if (m.isNumber(a) && e.element) {
                        var l = this.chart,
                            ...
                            p = l.dataItems.length,
                            d = l.series.getIndex(0);
                        if ("polygons" == this.gridType && p > 0 && d && c && c instanceof T.a) {
                            ...
                            for (var f = l.dataItems.length, v = 1; v < f; v++) g = c.getAngle(d.dataItems.getIndex(v), "categoryX", y), n += h.lineTo({
                                x: a * u.cos(g),
                                y: a * u.sin(g)
                            });
                            g = c.getAngle(d.dataItems.getIndex(f - 1), "categoryX", c.renderer.cellEndLocation), n += h.lineTo({
                                x: a * u.cos(g),
                                y: a * u.sin(g)
                            })
                        } else n = h.moveTo({
                    ...
                    var i, n = this.pixelInnerRadius,
                        ...
                        d = c.dataItems.length,
                        y = c.series.getIndex(0);
                    if ("polygons" == this.gridType && d > 0 && y && p && p instanceof T.a) {
                        var g = p.renderer.grid.template.location,
                            f = p.getAngle(y.dataItems.getIndex(0), "categoryX", g);
                        i = h.moveTo({
                            x: o * u.cos(f),
                            y: o * u.sin(f)
                        });
                        for (var m = c.dataItems.length, v = 1; v < m; v++) f = p.getAngle(y.dataItems.getIndex(v), "categoryX", g), i += h.lineTo({
                            x: o * u.cos(f),
                            y: o * u.sin(f)
                        });
                        f = p.getAngle(y.dataItems.getIndex(m - 1), "categoryX", p.renderer.cellEndLocation), i += h.lineTo({
                            x: o * u.cos(f),
                            y: o * u.sin(f)
                        }), i += h.moveTo({
                            x: a * u.cos(f),
                        ...
                        for (v = m - 1; v >= 0; v--) f = p.getAngle(y.dataItems.getIndex(v), "categoryX", g), i += h.lineTo({
                            x: a * u.cos(f),
                            y: a * u.sin(f)
                        })
                ...
                return r.c(t, e), t.prototype.validate = function() {
                    if (e.prototype.validate.call(this), !this.isTemplate) {
                        ...
                        if (this.middleLine.tensionX = D, this.middleLine.tensionY = I, m.isNumber(s) && m.isNumber(t) && m.isNumber(n) && m.isNumber(i) && m.isNumber(r)) {
                            ...
                            var _ = this.controlPointDistance,
                                O = c + (d - c) * _ * u.cos(a),
                                S = p + (y - p) * _ * u.sin(a),
                                R = d - (d - c) * _ * u.cos(o),
                                w = y - (y - p) * _ * u.sin(o),
                                ...
                                X = (s / u.cos(Y) - s) / u.tan(Y) * u.cos(a),
                                M = (s / u.sin(Y) - s) * u.tan(Y) * u.sin(a),
                                H = -X / 2 + g + (f - g) * _ * u.cos(a),
                                B = -M / 2 + v + (x - v) * _ * u.sin(a),
                                z = -X / 2 + f - (f - g) * _ * u.cos(o),
                                E = -M / 2 + x - (x - v) * _ * u.sin(o);
        ...
        var Ce = i("1yyj"),
            ...
            De = function(e) {
                ...
                return r.c(t, e), t.prototype.validateData = function() {
                    ...
                    var t, i, n = this.dataItem.values.value.sum;
                    _.each(this._sorted, function(t) {
                        ...
                        a / n < e.minNodeSize && (a = n * e.minNodeSize), m.isNumber(e._levelSum[r]) ? e._levelSum[r] += a : e._levelSum[r] = a, m.isNumber(e._levelNodesCount[r]) ? e._levelNodesCount[r]++ : e._levelNodesCount[r] = 1
                    }), t = "horizontal" == this.orientation ? this.chartContainer.maxHeight - 1 : this.chartContainer.maxWidth - 1, ne.each(this._levelSum, function(n, r) {
                        var a = r;
                        r = r * t / (t - (e._levelNodesCount[n] - 1) * e.nodePadding), e.maxSum < r && (e.maxSum = a, i = m.toNumber(n))
                    }), this._maxSumLevel = i;
                    var r = this._levelNodesCount[this._maxSumLevel],
                        a = (t - (r - 1) * this.nodePadding) / this.maxSum;
                    if (m.isNumber(this.valueHeight)) {
                        var o = void 0;
                        try {
                            o = this._heightAnimation.animationOptions[0].to
                        } catch (e) {}
                        if (o != a) {
                            var s = this.interpolationDuration;
                            try {
                                s = this.nodes.template.states.getKey("active").transitionDuration
                            } catch (e) {}
                            this._heightAnimation = new Ce.a(this, {
                                property: "valueHeight",
                                from: this.valueHeight,
                                to: a
                            }, s, this.interpolationEasing).start(), this._disposers.push(this._heightAnimation)
                        }
                    } else this.valueHeight = a
                }, t.prototype.validate = function() {
                    var t = this;
        ...
        var Ne = i("qCRI"),
            ...
            We = function(e) {
                function t() {
                    var t = e.call(this) || this;
                    t.layoutAlgorithm = t.squarify, t.zoomable = !0, t.className = "TreeMap", t._usesData = !0, t.maxLevels = 2, t.currentLevel = 0, t.colors = new de.a, t.sorting = "descending";
                ...
                return r.c(t, e), Object.defineProperty(t.prototype, "navigationBar", {
                    ...
                    _.each(this.series.iterator(), function(i) {
                        ...
                        }), i.level < t.currentLevel ? i.bulletsContainer.hide(e) : i.level == t.currentLevel && t.maxLevels > 1 && i.dataItems.each(function(e) {
        ...
        var qe = function(e) {
            ...
            // Here is that line you are looking for!!!
            Ue = function(e) {
                function t() {
                    var t = e.call(this) || this;
                    ...
                    _.each(this.series.iterator(), function(i) {
                        if (i instanceof Ge) {
                            ...
                            i.columns.each(function(e) {
                                e.zIndex = r ? 1e3 * (1e3 - a) + n - 100 * i.depthIndex : 1e3 * a + n - 100 * i.depthIndex, a++
                            }), r ? n-- : n++
                        }
                    }), this.maskColumns()
                }, t.prototype.processConfig = function(t) {
        ...
        var lt = function(e) {
            ...
            return r.c(t, e), t.prototype.createAssets = function() {
                ...
                return m.isNumber(e) || (e = this.radarColumn.tooltipX), e
            }, t.prototype.getTooltipY = function() {
                var e = this.getPropertyValue("tooltipX");
                return m.isNumber(e) || (e = this.radarColumn.tooltipY), e
            }, t
        }(He.a);
            ...
            ht = function(e) {
                ...
                return r.c(t, e), t.prototype.createColumnTemplate = function() {
                    ...
                    var t, i, n, r, a = this,
                        ...
                        s = this.chart.endAngle,
                        l = this.yField,
                        h = this.yOpenField,
                        c = this.xField,
                        p = this.xOpenField,
                        d = this.getStartLocation(e),
                        y = this.getEndLocation(e),
                        g = (s - o) / (this.dataItems.length * (this.end - this.start)),
                        f = this.columns.template.percentWidth;
                    m.isNaN(f) && (f = 100);
                    var v = u.round((y - d) * (1 - f / 100) / 2, 5);
                    if (d += v, y -= v, this.baseAxis == this.xAxis ? (n = u.getDistance({
                        ...
                        }), t = this.xAxis.getAngle(e, p, d, "valueX"), i = this.xAxis.getAngle(e, c, y, "valueX"), o += d * g, s -= (1 - y) * g) : (n = u.getDistance({
                            x: this.yAxis.getX(e, l, d, "valueY"),
                            y: this.yAxis.getY(e, l, d, "valueY")
                        }), r = u.getDistance({
                            x: this.yAxis.getX(e, h, y, "valueY"),
                            y: this.yAxis.getY(e, h, y, "valueY")
                        }), t = this.xAxis.getAngle(e, c, e.locations[c], "valueX"), i = this.xAxis.getAngle(e, p, e.locations[p], "valueX")), i < t) {
                        var x = i;
                        i = t, t = x
                    }
                    t = u.fitToRange(t, o, s), i = u.fitToRange(i, o, s);
                    var b = e.column;
                    b || (b = this.columns.create(), e.column = b, ne.forceCopyProperties(this.columns.template, b, J.b), e.addSprite(b), b.paper = this.paper, this.setColumnStates(b));
                    var P = b.radarColumn;
                    P.startAngle = t;
                    var C = i - t;
                    C > 0 ? (P.arc = C, P.radius = n, P.innerRadius = r, b.__disabled = !1, b.parent = this.columnsContainer, _.each(this.axisRanges.iterator(), function(i) {
                        ...
                        var s = o.radarColumn;
                        s.startAngle = t, s.arc = C, s.radius = n, s.innerRadius = r, s.invalid && (s.paper = a.paper, s.validate()), o.__disabled = !1, o.parent = i.contents
        ...
        var xt = function(e) {
            ...
            bt = function(e) {
                function t() {
                    var t = e.call(this) || this;
                    return t.className = "PictorialStackedSeries", t.topWidth = Object(o.c)(100), t.bottomWidth = Object(o.c)(100), t.valueIs = "height", t.applyTheme(), t.startLocation = 0, t.endLocation = 1, t._maskSprite = t.slicesContainer.createChild(J.a), t._maskSprite.visible = !1, t._maskSprite.zIndex = 100, t._maskSprite.shouldClone = !1, t
                }
                return r.c(t, e), t.prototype.validateDataElements = function() {
                    ...
                    var s = this.startLocation,
                        ...
                        h = u.min(t, r * o),
                        c = u.min(i, a * o);
                    if (n.scale = o, "vertical" == this.orientation ? (this.topWidth = h + 4, this.bottomWidth = h + 4, this.pyramidHeight = c * (l - s), n.x = t / 2, n.y = c / 2) : (this.topWidth = c + 4, this.bottomWidth = c + 4, this.pyramidHeight = h * (l - s), n.valign = "middle", n.x = h / 2, n.y = i / 2), n.verticalCenter = "middle", n.horizontalCenter = "middle", e.prototype.validateDataElements.call(this), "vertical" == this.orientation) {
                        var p = (i - c) / 2;
                        this.slicesContainer.y = p, this.labelsContainer.y = p, this.ticksContainer.y = p, this.slices.template.dy = s * c
                    } else {
                        var d = (t - h) / 2;
                        this.slicesContainer.x = d, this.labelsContainer.x = d, this.ticksContainer.x = d, this.slices.template.dx = s * h
                    }
                    h > 0 && c > 0 && (this.slicesContainer.mask = this._maskSprite)
                }, t.prototype.applyInternalDefaults = function() {
                    e.prototype.applyInternalDefaults.call(this), m.hasValue(this.readerTitle) || (this.readerTitle = this.language.translate("Pyramid Series"))
                }, t.prototype.createDataItem = function() {
                    return new xt
