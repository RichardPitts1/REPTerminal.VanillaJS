am4core.ready(function() {
    ...
    var chart = am4core.create("stadiumChartdiv", am4plugins_timeline.CurveChart);
    chart.curveContainer.padding(0,30,0,19);
    
    chart.data = [{ name: "World", file: "/wp-content/uploads/assets/timeline/chandler.jpg", track: 1, value: 450 }, { name: "North America", file: "/wp-content/uploads/assets/timeline/ross.jpg", track: 2, value: 650 }, { name: "South America", file: "/wp-content/uploads/assets/timeline/joey.jpg", track: 3, value: 578 }, { name: "Asia", file: "/wp-content/uploads/assets/timeline/monica.jpg", track: 4, value: 730 }, { name: "Australia", file: "/wp-content/uploads/assets/timeline/phoebe.jpg", track: 5, value: 490 }, { name: "Europe", file: "/wp-content/uploads/assets/timeline/rachel.jpg", track: 6, value: 532 }];
    
    var categoryAxis = chart.yAxes.push(new am4charts.CategoryAxis());
    categoryAxis.dataFields.category = "name";
    categoryAxis.renderer.minGridDistance = 10;
    categoryAxis.renderer.innerRadius = 5;
    categoryAxis.renderer.radius = 66;
    ...
    flagBullet.label.text = "10 yr return";
